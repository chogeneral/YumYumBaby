...
export const babyFoodRecipes = [
  ...
  },
  {
    ...
    stage: "early",
    name: "소고기 사과(배) 미음",
    description: "철분이 풍부한 소고기와 새콤달콤한 사과(또는 배)를 함께 갈아 만드는 초기 이유식입니다. 소고기의 잡내를 사과·배가 잡아주어 아기가 거부감 없이 잘 먹습니다.",
    ingredients: "불린 쌀 30g, 소고기(안심 또는 우둔살) 15g, 사과(또는 배) 20g, 물 400ml",
    instructions: [
      "소고기는 찬물에 30분 담가 핏물을 제거합니다. 사과(또는 배)는 껍질과 씨를 제거하고 20g을 준비합니다.",
      "냄비에 물 100ml와 소고기를 넣고 완전히 익을 때까지 삶습니다. 삶은 소고기를 건져내고 육수는 따로 보관합니다.",
      "믹서에 삶은 소고기와 육수 일부를 넣고 곱게 갈아줍니다. 사과(배)는 끓는 물에 1분간 데쳐 건져낸 뒤 믹서에 함께 갈아줍니다.",
      "불린 쌀 30g과 남은 물을 믹서에 넣고 곱게 갈아줍니다. 냄비에 갈아둔 쌀, 소고기, 사과(배)와 남은 물을 모두 부어 센 불로 끓입니다.",
      "끓어오르면 약불로 줄여 7~8분간 주걱으로 저어가며 끓인 뒤 고운 체에 걸러 이유식 용기에 담아 완성합니다."
    ],
    tips: "소고기는 기름기 없는 안심이나 우둔살을 사용하세요. 사과와 배는 각각 따로 만들어두면 다양하게 활용할 수 있습니다. 냉장 3일, 냉동 7일 보관 가능합니다."
  },
  {
    id: "recipeEarly09",
    stage: "early",
