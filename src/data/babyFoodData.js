...
export const babyFoodRecipes = [
  ...
  },
  {
    ...
    stage: "middle",
    name: "닭고기 감자비트죽",
    description: "닭고기 육수로 끓이는 중기 이유식입니다. 알록달록한 비트를 더해 색감과 영양을 높였으며 완성량 180~210ml 기준입니다.",
    ingredients: "불린 중기 쌀 30g, 닭고기(안심살 또는 가슴살) 25g, 감자 15g, 비트 15g, 닭고기 육수 200ml",
    instructions: [
      "닭고기의 하얀 유막과 질긴 힘줄을 칼로 제거합니다. 분유나 모유에 잠시 담가 잡내를 뺀 뒤 끓는 물에 넣어 삶습니다. 삶는 동안 체망으로 불순물 거품을 걷어내고, 삶은 물을 고운 망에 걸러 육수 200ml를 계량합니다. 닭고기는 건져 한 김 식혀둡니다.",
      "비트(15g)는 중기 입자 크기에 맞게 칼로 곱게 다집니다. 감자(15g)는 찜기에 푹 쪄낸 뒤 뜨거울 때 매셔나 스푼으로 덩어리 없이 곱게 으깹니다. 식혀둔 닭고기도 중기 입자 크기에 맞게 잘게 다집니다.",
      "냄비에 닭고기 육수 200ml를 붓고 불린 쌀 30g과 다진 닭고기를 넣습니다. 불을 켜기 전 주걱으로 고기가 뭉치지 않도록 가볍게 풀어줍니다.",
      "센 불에서 바닥이 눌어붙지 않게 저어가며 끓입니다. 전체적으로 끓기 시작하면 즉시 약불로 줄이고 으깬 감자를 먼저 넣은 뒤 다진 비트도 넣어 잘 스며들도록 저어가며 뭉근히 끓입니다.",
      "주걱으로 쌀알을 눌러 잇몸으로 으깨질 만큼 부드러워지면 완성입니다. 되직해지면 따뜻한 물을 소량 추가하고, 평소보다 살짝 묽은 느낌일 때 불을 끕니다."
    ],
    tips: "이유식은 식으면 더 되직해지므로 살짝 묽게 마무리하세요. 별도 소금 없이도 닭고기·채소 자체의 자연 나트륨으로 간이 충분합니다."
  },
  {
    id: "recipeMiddle07",
    stage: "middle",
    name: "달걀 애호박 당근죽",
    description: "달걀 노른자(난황)와 애호박·당근을 함께 끓이는 중기 이유식입니다. 노른자를 날것으로 풀어 넣거나 완숙으로 삶아 체에 내리는 두 가지 방법으로 만들 수 있으며 완성량 180~210ml 기준입니다.",
    ingredients: "불린 중기 쌀 30g, 달걀 난황 25g (특란 노른자 1개 분량), 애호박 15g, 당근 15g, 물 200ml",
    instructions: [
      "달걀 흰자를 제외한 노른자만 분리하고 젓가락으로 알끈을 제거합니다. 당근은 단단한 심지를 제거한 뒤 끓는 물에 데쳐 중기 입자 크기로 잘게 다집니다. 애호박은 껍질과 씨를 제거한 뒤 끓는 물에 데쳐 같은 크기로 다집니다.",
      "냄비에 불린 쌀 30g과 물 200ml를 넣고 센 불에서 바닥이 눌지 않게 저어가며 끓입니다. 전체적으로 끓기 시작하면 약불로 줄이고 다진 당근과 애호박을 넣어 뭉치지 않게 저어가며 뭉근히 끓입니다.",
      "[방법 1 - 날노른자] 죽이 걸쭉해지면 풀어둔 날노른자를 조금씩 부어가며 재빨리 저어 섞습니다. 되직해지면 따뜻한 물을 소량 추가해 농도를 맞춥니다.",
      "[방법 2 - 삶은 노른자] 완숙으로 삶은 달걀에서 노른자만 분리해 고운 체망 위에 올리고, 스푼으로 으깨가며 죽 위로 내려줍니다. 뭉치지 않게 골고루 풀어가며 끓입니다.",
      "쌀알을 주걱으로 눌러 잇몸으로 으깨질 만큼 부드러워지면 완성입니다. 살짝 묽은 느낌일 때 불을 끄세요."
    ],
    tips: "중기에는 반드시 노른자(난황)만 사용하세요. 날노른자를 풀어 넣는 방식과 완숙 노른자를 체에 내리는 방식 중 편한 방법을 선택하면 됩니다. 별도 소금 없이도 식재료 자체의 자연 나트륨으로 간이 충분합니다."
  },
  {
    id: "recipeMiddle08",
    stage: "middle",
    name: "닭고기 아보카도 고구마죽",
    description: "닭고기 육수로 끓이는 3끼 분량의 중기 이유식입니다. 양파를 넣어 육수 맛을 내고 아보카도·고구마를 3mm 이하로 다져 넣어 담백하고 부드럽게 완성됩니다.",
    ingredients: "중기용 쌀 48~60g, 닭고기 45g, 아보카도 30g, 고구마 30g, 육수용 양파 15g, 물 660ml",
    instructions: [
      "중기용 쌀에 찬물을 부어 덩어리지지 않도록 충분히 풀어둡니다. 닭고기는 찬물에 1시간 담가 핏물을 제거합니다.",
      "냄비에 물 660ml, 핏물 뺀 닭고기, 양파 15g을 넣고 함께 끓여 육수를 냅니다. 고기가 다 익으면 닭고기만 건져냅니다.",
      "건져낸 닭고기를 3mm 이하 크기로 잘게 다진 뒤 절구로 한 번 더 곱게 으깹니다. 아보카도와 고구마도 각각 3mm 이하 크기로 잘게 다져 준비합니다.",
      "완성된 닭고기 육수에 다진 닭고기와 찬물에 풀어둔 쌀을 먼저 넣고 섞습니다. 이어서 다진 고구마와 아보카도도 모두 넣어줍니다.",
      "바글바글 끓어오르기 시작하면 약불로 줄이고 바닥이 눌지 않게 주걱으로 저어가며 보통 죽 농도가 될 때까지 뭉근히 끓여 완성합니다."
    ],
    tips: "쌀을 찬물에 미리 풀어두면 육수에 넣을 때 뭉침 없이 고르게 섞입니다. 아보카도는 조리 시 함께 넣어도 됩니다."
  },
  {
    id: "recipeMiddle09",
    stage: "middle",
  ...
  },
  {
    ...
    stage: "late",
    name: "두부 시금치죽",
    description: "죽 위에 재료를 얹는 토핑 형태의 후기 이유식입니다. 볶은 두부와 데친 시금치를 얹어 아기가 눈으로도 즐길 수 있으며 한 끼 약 50g 기준입니다.",
    ingredients: "진밥 (어른 숟가락 수북이 3큰술), 두부 적당량, 시금치 적당량, 물 150ml, 토핑용 볶은 고기 가루·데친 당근·부추 등 (기호에 따라)",
    instructions: [
      "두부는 물기를 짠 뒤 손으로 바락바락 문질러 으깨고, 기름을 두르지 않은 달군 팬에 살짝 볶아 수분을 날려 준비합니다. 시금치는 살짝 데쳐 입자감 있게 다져 준비합니다.",
      "냄비에 진밥 3숟가락과 물 150ml를 넣고 불을 켜 살살 저어가며 한소끔 끓입니다.",
      "흰 미음이 바글바글 끓어오르면 볶아둔 두부를 넣고, 이어서 다진 시금치를 1큰술 넣어줍니다.",
      "약불로 줄이고 냄비 바닥이 눌지 않게 저어가며 3~5분 수분이 알맞게 날아갈 때까지 졸입니다. 아기 컨디션이 좋지 않을 때는 국물이 자작할 때 불을 꺼 부드럽게 줍니다.",
      "되직한 후기 죽 형태가 되면 아기 그릇에 옮겨 담고, 볶은 고기 가루·데친 당근·부추 등 토핑 재료를 군데군데 얹어 완성합니다."
    ],
    tips: "토핑 재료(당근, 고기 등)는 미리 큐브로 만들어 냉동해 두면 필요할 때마다 꺼내 얹기만 하면 됩니다. 볶은 두부는 간식으로 유모차·보행기 탈 때 아기 그릇에 담아 쥐여줘도 좋습니다."
  },
  {
    id: "recipeLate12",
    stage: "late",
