...
export const babyFoodRecipes = [
  ...
  },
  {
    ...
    instructions: [
      "사과(또는 배)는 껍질과 씨를 제거하고 20g을 준비합니다. 끓는 물에 넣고 약 1분간 데쳐낸 후 건져냅니다.",
      "계량컵에 불린 쌀 30g과 물 400ml 중 일부를 넣고 믹서(핸드블렌더)로 곱게 갈아줍니다.",
      "쌀이 곱게 갈리면 데쳐놓은 사과(또는 배) 20g을 추가하여 입자가 남지 않도록 완전히 곱게 갈아줍니다.",
      "냄비에 갈아놓은 재료와 남은 물을 모두 부어 센 불로 끓이다가 끓어오르면 약불로 줄여 약 7~8분간 주걱으로 저어가며 끓입니다.",
      "완성된 미음을 고운 체에 걸러 부드럽게 만든 뒤 식혀서 이유식 용기에 나누어 담아 완성합니다."
    ],
    tips: "처음엔 농도가 묽어 보여도 식으면 되직해집니다. 불의 세기나 냄비 종류에 따라 수분이 빨리 증발할 수 있으니 묽을 경우 물을 조금 더 추가하세요. 사과 미음과 배 미음을 같은 방법으로 각각 만들어두면 편리합니다."
  },
  {
    id: "recipeEarly09",
    stage: "early",
