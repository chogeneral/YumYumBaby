-- =============================================
-- 베베레시피 초기 레시피 시드 데이터 (33개)
-- Supabase 대시보드 > SQL Editor 에서 실행하세요.
-- =============================================

insert into public.recipes (id, stage, name, description, ingredients, instructions, tips) values

-- 초기 이유식 (early) 12개
('recipeEarly01', 'early', '첫걸음 쌀미음',
 '이유식의 가장 첫 단계로, 소화가 잘 되고 알레르기 유발 가능성이 가장 적은 기본 쌀가루 미음입니다.',
 '쌀가루 10g, 찬물 200ml (20배 희석 비율)',
 array[
 ...
 '이유식을 처음 시작하는 아기는 숟가락 감촉에 낯설어할 수 있습니다. 억지로 먹이기보다 하루 한두 숟가락으로 재미있게 연습하는 마음으로 다가가세요.'),

('recipeEarly02', 'early', '애호박 미음',
 '달콤하고 부드러워 아기들에게 인기가 좋으며 소화 흡수가 잘 되는 대표적인 야채 미음입니다.',
 '쌀가루 10g, 애호박 속살 10g, 찬물 200ml',
 array[
 ...
 '애호박 껍질에는 섬유질이 많아 초기 아기 장에 무리가 갈 수 있으므로 반드시 껍질과 씨앗은 도려내고 초록색 속살 부분만 활용합니다.'),

('recipeEarly03', 'early', '브로콜리 미음',
 '비타민 C와 칼슘이 풍부하여 면역력을 높여주며, 야채 특유의 향에 적응을 도와주는 영양 미음입니다.',
 '쌀가루 10g, 브로콜리 꽃송이 부분 10g, 찬물 200ml',
 array[
   '브로콜리는 단단한 기둥 줄기 부분은 잘라 버리고 영양이 가득하고 부드러운 꽃송이 윗부분만 칼로 도려내어 10g 준비합니다.',
   '식초를 떨어뜨린 물에 브로콜리 꽃송이를 5분간 담가두었다가 흐르는 물에 깨끗이 세척합니다.',
   '끓는 물에 브로콜리 꽃송이를 넣어 약 2~3분간 푹 삶은 다음 건져 찬물에 헹굽니다.',
   '믹서기에 삶은 브로콜리와 찬물을 약간 넣고 미세하게 갈아 입자를 최소화합니다.',
   '냄비에 쌀가루 10g, 찬물 200ml, 갈아둔 브로콜리를 모두 넣고 섞은 뒤 불에 올려 저어가며 5분간 뭉근히 끓여 체에 걸러 완성합니다.'
 ],
 '브로콜리 줄기는 매우 질기므로 초기에는 절대로 사용하지 마세요. 꽃 봉오리 부분만 잘 활용해도 풍부한 항산화 성분을 줄 수 있습니다.'),

('recipeEarly04', 'early', '고소한 고구마 미음',
 '식이섬유가 풍부해 변비 예방에 탁월하며 자연스러운 단맛이 있어 편식하는 아기들도 매우 잘 먹는 미음입니다.',
 '쌀가루 10g, 고구마 15g, 찬물 200ml',
 array[
 ...
 '밤고구마보다는 부드럽고 수분감이 많은 호박고구마를 사용하면 체에 거르기가 한결 쉬우며 달콤한 맛도 배가 됩니다.'),

('recipeEarly05', 'early', '달콤 단호박 미음',
 '베타카로틴이 풍부하고 자연적인 단맛이 있어 이유식 초기부터 아기들이 잘 받아들이는 인기 미음입니다.',
 '쌀가루 10g, 단호박 속살 15g, 찬물 200ml',
 array[
   '단호박은 반으로 갈라 씨를 제거한 뒤 껍질을 두껍게 깎아냅니다.',
 ...
 '단호박을 찌기 전에 전자레인지에 2분 정도 돌리면 단단한 껍질을 벗기기가 훨씬 수월합니다.'),

('recipeEarly06', 'early', '부드러운 감자 미음',
 '탄수화물 에너지원이자 소화가 매우 잘 되어 초기 이유식에 적합하며, 알레르기 유발 가능성이 극히 낮은 안전한 식재료입니다.',
 '쌀가루 10g, 감자 15g, 찬물 200ml',
 array[
   ...
   '중불에서 가열하며 저어주다가 끓어오르면 약불로 줄여 5~6분 더 끓여 체에 한 번 걸러 완성합니다.'
 ],
 '감자 삶은 물은 버리고 찬물로 미음을 만드는 것이 적절한 농도 조절에 유리합니다.'),

('recipeEarly07', 'early', '당근 미음',
 '베타카로틴과 비타민 A가 풍부해 눈 건강과 면역력 강화에 도움을 주는 대표적인 주황빛 야채 미음입니다.',
 '쌀가루 10g, 당근 10g, 찬물 200ml',
 array[
   '당근은 흐르는 물에 솔로 문질러 겉을 깨끗이 세척한 후 껍질을 칼로 얇게 깎아냅니다.',
   '껍질을 벗긴 당근을 얇게 썰어 끓는 물에 완전히 투명하게 무를 때까지 10분 이상 삶아냅니다.',
   '삶은 당근을 건져 믹서기에 넣고 찬물 약간과 함께 최대한 곱게 갈아냅니다.',
   '간 당근을 고운 체에 한 번 걸러 입자를 최소화하여 고운 당근 퓨레를 준비합니다.',
   '냄비에 찬물 200ml와 쌀가루 10g, 당근 퓨레를 넣고 잘 섞은 뒤 중불로 저어가며 끓여 완성합니다.'
 ],
 '당근은 지용성 비타민인 베타카로틴을 함유하므로, 아기가 쌀미음에 충분히 적응한 후 당근 미음을 주면 영양 흡수에 도움이 됩니다.'),

('recipeEarly08', 'early', '사과 배 혼합 미음',
 '사과의 펙틴 성분과 배의 수분이 합쳐져 변비를 예방하고 소화를 돕는 과일 미음입니다. 자연스러운 단맛으로 아기가 잘 먹습니다.',
 '쌀가루 10g, 사과 과육 10g, 배 과육 10g, 찬물 180ml',
 array[
   '사과와 배는 각각 깨끗이 씻어 껍질과 씨를 완전히 제거합니다.',
   '사과 과육을 작게 잘라 냄비에 물 약간과 함께 부드러워질 때까지 5~7분간 가열하여 익힙니다. 배는 생으로 갈아도 됩니다.',
 ...
 '과일 미음은 수유 후 간식 개념으로 소량 제공하고, 식사 대용으로 사용하지 않도록 합니다.'),

('recipeEarly09', 'early', '완두콩 미음',
 '식물성 단백질과 식이섬유가 풍부한 완두콩은 초기 이유식에 사용 가능한 콩류로, 선명한 초록빛이 아기의 식욕을 돋웁니다.',
 '쌀가루 10g, 완두콩 (냉동 또는 생것) 15g, 찬물 200ml',
 array[
   '냉동 완두콩은 미지근한 물에 10분간 해동하고, 생 완두콩은 꼬투리에서 분리하여 준비합니다.',
   '끓는 물에 완두콩을 넣어 완전히 물러질 때까지 8~10분간 삶습니다.',
 ...
 '완두콩은 처음 제공 시 소량부터 시작해 2~3일간 반응을 관찰합니다. 체에 걸러낸 완두콩 껍질은 버리고, 퓨레만 사용해야 소화하기 편합니다.'),

('recipeEarly10', 'early', '시금치 미음',
 '철분과 엽산이 풍부한 시금치로 만든 진한 초록빛 미음입니다. 색이 강해 처음엔 거부할 수 있지만 다른 재료와 섞으면 잘 먹습니다.',
 '쌀가루 10g, 시금치 잎 부분 10g, 찬물 200ml',
 array[
 ...
 '시금치에는 옥살산이 있어 데쳐서 사용하는 것이 중요합니다. 수유 전에 제공하는 것이 좋습니다.'),

('recipeEarly11', 'early', '바나나 미음',
 '에너지가 풍부하고 으깨기 쉬우며 자연스러운 단맛이 나는 바나나로 만든 간편 미음입니다. 별도의 조리 없이 빠르게 준비 가능합니다.',
 '쌀가루 10g, 잘 익은 바나나 15g, 찬물 200ml',
 array[
   ...
   '중불에서 저어가며 끓이다가 끓어오르면 약불로 줄여 3~4분 더 가열하여 완성합니다.'
 ],
 '바나나 미음은 식으면 빠르게 갈변하고 맛이 변하므로, 만든 즉시 아기에게 제공하고 남기지 않는 것이 원칙입니다.'),

('recipeEarly12', 'early', '청경채 미음',
 '칼슘과 비타민 K가 풍부한 청경채는 뼈 성장에 도움을 주는 초록잎 채소로, 브로콜리 미음에 익숙해진 후 다음 단계로 시도하기 좋습니다.',
 '쌀가루 10g, 청경채 잎 부분 10g, 찬물 200ml',
 array[
 ...
 '청경채는 특유의 향이 있어 처음에는 소량씩 혼합하여 제공하다가 점차 비율을 높입니다. 줄기 부분은 초기에 사용하지 않습니다.'),

-- 중기 이유식 (middle) 11개
('recipeMiddle01', 'middle', '한우 소고기 브로콜리죽',
 '생후 6개월 이후 모유 수유아에게 결핍되기 쉬운 철분 보충을 위한 필수 영양 죽입니다.',
 '불린 쌀 30g, 소고기 안심(또는 우둔살) 20g, 브로콜리 15g, 소고기 육수 240ml',
 array[
   '소고기는 지방과 힘줄이 없는 안심 부위로 준비하고, 찬물에 10~15분 정도 담가 핏물을 살짝 뺀 후 끓는 물에 넣어 푹 삶아냅니다.',
 ...
 '소고기 핏물을 너무 오래 빼면 철분 성분이 다소 손실될 수 있으므로 15분 이내가 적당합니다.'),

('recipeMiddle02', 'middle', '달콤 단호박 닭고기죽',
 '달콤한 단호박과 담백하고 소화가 잘 되는 닭고기 가슴살이 부드럽게 조화된 중기 영양식입니다.',
 '불린 쌀 30g, 닭가슴살 20g, 단호박 20g, 채수 또는 닭고기 육수 240ml',
 array[
 ...
 '단호박 자체에 전분이 있어 일반 죽보다 빠르게 냄비 바닥이 탈 수 있으므로 더 정성껏 바닥을 저어주어야 합니다.'),

('recipeMiddle03', 'middle', '대구살 당근 애호박죽',
 '부드럽고 단백질이 풍부한 흰살생선 대구살을 이용해 담백하고 깔끔하게 끓여낸 중기죽입니다.',
 '불린 쌀 30g, 다진 대구살 20g, 당근 10g, 애호박 15g, 야채 육수 240ml',
 array[
   '생물 대구살을 사와서 가시가 전혀 없는지 만져보며 꼼꼼히 확인하고 끓는 물에 데쳐냅니다.',
 ...
 '대구 등 흰살생선은 지방 함량이 적고 단백질이 많아 이유식에 안성맞춤입니다. 조리 전 손가락 끝으로 잔가시를 반드시 확인하세요.'),

('recipeMiddle04', 'middle', '시금치 소고기죽',
 '철분이 풍부한 소고기와 엽산이 가득한 시금치를 함께 넣어 중기 아기의 빈혈 예방과 성장 발달을 동시에 챙기는 영양죽입니다.',
 '불린 쌀 30g, 소고기 다짐육 20g, 시금치 잎 15g, 소고기 육수 240ml',
 array[
 ...
 '시금치는 너무 오래 끓이면 색이 검게 변하므로 마지막 5분 안에 넣는 것이 색감 유지에 좋습니다.'),

('recipeMiddle05', 'middle', '닭고기 감자죽',
 '소화가 부드러운 닭가슴살과 탄수화물이 풍부한 감자를 함께 끓여 에너지 보충에 탁월하고, 아이가 거부감 없이 잘 먹는 맛있는 중기죽입니다.',
 '불린 쌀 30g, 닭가슴살 20g, 감자 20g, 채수 또는 닭 육수 240ml',
 array[
 ...
 '감자에 전분이 많아 일반 죽보다 빠르게 바닥이 눌어붙을 수 있습니다. 물의 양을 약간 넉넉하게 잡고 자주 저어주세요.'),

('recipeMiddle06', 'middle', '두부 당근죽',
 '부드러운 두부로 식물성 단백질을 보충하고 당근으로 비타민을 채우는 건강한 중기 이유식입니다.',
 '불린 쌀 30g, 두부 30g, 당근 15g, 야채 육수 240ml',
 array[
   '두부는 면포나 키친타월에 감싸 가볍게 눌러 수분을 빼낸 뒤 잘게 으깨거나 다집니다.',
   '당근은 껍질을 벗기고 2mm 크기로 곱게 다집니다.',
 ...
 '두부는 조리 전 반드시 끓는 물에 한 번 데쳐 사용하면 잡내가 제거되고 위생적으로도 안전합니다.'),

('recipeMiddle07', 'middle', '계란 노른자 채소죽',
 '양질의 단백질과 레시틴이 풍부한 계란 노른자를 처음 시도하기 좋은 중기 이유식입니다. 뇌 발달에 도움을 주는 영양죽입니다.',
 '불린 쌀 30g, 계란 노른자 1개, 애호박 15g, 당근 10g, 야채 육수 240ml',
 array[
   ...
   '계란이 익어 노란빛이 죽 전체에 배면 완성입니다.'
 ],
 '계란 노른자는 중기(7개월 이후)부터 시도를 권장합니다. 흰자는 알레르기를 유발할 수 있으므로 돌 전에는 노른자만 사용합니다.'),

('recipeMiddle08', 'middle', '고구마 닭고기죽',
 '달콤한 고구마와 담백한 닭고기가 조화로운 중기 이유식입니다. 식이섬유가 풍부해 변비가 있는 아기에게 특히 추천합니다.',
 '불린 쌀 30g, 닭가슴살 20g, 고구마 20g, 닭 육수 또는 채수 240ml',
 array[
 ...
 '고구마 이유식은 단맛이 강해져 맹물 이유식을 거부하게 될 수 있습니다. 3일에 한 번 정도로 조절합니다.'),

('recipeMiddle09', 'middle', '연두부 시금치죽',
 '시중 연두부를 활용한 간편하고 영양이 가득한 중기 이유식입니다. 일반 두부보다 훨씬 부드러워 중기 초반 아기에게 잘 맞습니다.',
 '불린 쌀 30g, 연두부 30g, 시금치 잎 10g, 야채 육수 240ml',
 array[
 ...
 '연두부는 수분이 많아 죽의 농도가 묽어질 수 있습니다. 쌀의 양을 약간 늘리거나 육수를 조금 줄여서 농도를 조절하면 됩니다.'),

('recipeMiddle10', 'middle', '새우살 브로콜리죽',
 '풍부한 단백질과 아연이 함유된 새우살로 아기의 성장과 면역력을 동시에 챙기는 중기 이유식입니다.',
 '불린 쌀 30g, 새우살 (냉동 무첨가) 20g, 브로콜리 꽃송이 15g, 야채 육수 240ml',
 array[
   '냉동 새우살은 냉장실에서 해동하거나 흐르는 찬물에 해동합니다. 첨가물이 없는 순수 새우살을 선택합니다.',
   '해동된 새우살을 끓는 물에 데쳐 익힌 뒤 잘게 다집니다.',
 ...
 '새우는 알레르기를 유발할 수 있습니다. 반드시 소량부터 시작하여 2~3일간 반응을 관찰합니다. 가족 중 갑각류 알레르기가 있다면 의사와 상의 후 제공합니다.'),

('recipeMiddle11', 'middle', '양배추 소고기죽',
 '위장을 보호하는 비타민 U가 풍부한 양배추와 철분이 가득한 소고기를 함께 사용한 소화에 좋은 중기 영양죽입니다.',
 '불린 쌀 30g, 소고기 다짐육 20g, 양배추 15g, 소고기 육수 240ml',
 array[
 ...
 '양배추를 먼저 살짝 볶으면 아기가 싫어하는 특유의 유황 냄새가 줄어듭니다. 부드러운 잎 부분만 사용합니다.'),

-- 후기/완료기 이유식 (late) 10개
('recipeLate01', 'late', '소고기 모듬버섯 진밥',
 '씹는 재미가 있고 영양가 높은 버섯과 소고기를 듬뿍 넣어 밥알의 식감을 살린 영양 진밥입니다.',
 '진밥 80g (또는 쌀 40g), 소고기 안심 30g, 표고버섯 15g, 새송이버섯 15g, 당근 10g, 야채 고기 육수 150ml',
 array[
 ...
 '표고버섯 향이 너무 강해 아기가 거부한다면 버섯을 데친 뒤 찬물에 살짝 담가두었다가 사용하면 향이 완화됩니다.'),

('recipeLate02', 'late', '핑거푸드 소고기 야채 주먹밥',
 '아기가 스스로 집어 먹는 자기주도 이유식을 위한 최적의 귀여운 핑거푸드 주먹밥입니다.',
 '진밥 80g, 다진 소고기 20g, 애호박 10g, 당근 10g, 아기참기름 2~3방울',
 array[
 ...
 '주먹밥을 너무 크거나 단단하게 뭉치면 아기 목에 걸릴 위험이 있습니다. 한 입에 쏙 들어가고 잇몸으로 쉽게 부서지는 점도로 만들어 주세요.'),

('recipeLate03', 'late', '아기 두부 달걀찜',
 '부드러운 계란 노른자와 두부를 이용하여 아기의 단백질 반찬으로 활용하기 좋은 부드러운 찜 요리입니다.',
 '두부 30g, 계란 노른자 1개, 물 또는 육수 50ml, 브로콜리 약간 (고명용)',
 array[
 ...
 '완료기 이전의 아기에게는 알레르기 유발 위험이 있는 계란 흰자 대신 노른자만 사용해 주는 것이 소화 및 안전에 훨씬 좋습니다.'),

('recipeLate04', 'late', '연어 야채 진밥',
 '오메가-3 지방산과 DHA가 풍부한 연어로 두뇌 발달을 돕는 후기 이유식입니다.',
 '진밥 80g (또는 쌀 40g), 연어살 30g, 애호박 15g, 당근 10g, 야채 육수 120ml',
 array[
   '연어는 껍질을 제거하고 가시가 없는지 꼼꼼히 확인합니다. 끓는 물에 2~3분간 데쳐 표면을 익힌 후 잘게 다집니다.',
   '애호박과 당근은 껍질을 벗기고 3~5mm 크기로 다집니다.',
 ...
 '연어는 지방 함량이 높아 소화가 약한 아기에게 처음 제공할 때는 소량으로 시작합니다. 냉동 연어는 완전히 해동 후 신선도를 반드시 확인합니다.'),

('recipeLate05', 'late', '닭고기 채소 볶음밥',
 '아기의 자기 주도 이유식을 돕는 후기 볶음밥입니다. 닭고기와 다양한 채소를 볶아 완성도 높은 한 끼를 만들 수 있습니다.',
 '진밥 80g, 닭가슴살 다짐육 25g, 양파 10g, 당근 10g, 애호박 10g, 참기름 2방울',
 array[
 ...
 '아기 볶음밥은 간을 전혀 하지 않는 것이 원칙입니다. 양파가 들어가면 자연스러운 단맛이 나서 아기가 더 잘 먹습니다.'),

('recipeLate06', 'late', '아기 계란 야채 오믈렛',
 '단백질이 풍부한 계란 전란을 처음 활용하는 후기 핑거푸드입니다. 한 손에 쥐기 좋은 크기로 만들어 자기 주도 이유식에 최적화된 반찬입니다.',
 '계란 1개, 애호박 10g, 당근 5g, 양파 5g, 식용유 소량',
 array[
   '완료기(12개월 전후)에 계란 흰자를 처음 시도할 때는 아기의 반응을 살핀 후 사용합니다. 10개월 이하라면 노른자 2개로 대체합니다.',
   '애호박, 당근, 양파는 최대한 잘게 다집니다. 팬에 물을 약간 두르고 살짝 볶아 부드럽게 익힙니다.',
 ...
 '계란 오믈렛은 반드시 완전히 익혀야 합니다. 반숙 상태는 식중독 위험이 있으므로 아기에게 절대 금지입니다.'),

('recipeLate07', 'late', '돼지고기 두부 야채죽',
 '부드럽고 담백한 돼지 안심과 두부를 함께 사용하여 동물성·식물성 단백질을 균형 있게 섭취할 수 있는 후기 이유식입니다.',
 '진밥 80g (또는 쌀 40g), 돼지고기 안심 25g, 두부 25g, 애호박 15g, 야채 육수 130ml',
 array[
 ...
 '돼지고기는 반드시 완전히 익혀야 합니다. 돼지 안심은 지방이 거의 없어 소화가 잘 되므로 후기 이유식에 적합합니다.'),

('recipeLate08', 'late', '아기 미역 소고기국',
 '칼슘과 요오드가 풍부한 미역을 활용한 후기 이유식 국입니다. 진밥과 함께 제공하면 균형 잡힌 한 끼 식사가 됩니다.',
 '불린 미역 10g, 소고기 안심 25g, 참기름 2방울, 물 250ml',
 array[
 ...
 '미역에는 요오드가 풍부하므로 매일 먹이기보다는 주 2~3회 정도가 적당합니다. 국은 진밥에 말아 제공하면 아기가 먹기 편합니다.'),

('recipeLate09', 'late', '새우 완두콩 진밥',
 '쫄깃한 새우와 달콤한 완두콩의 조합으로 색감도 예쁘고 영양도 알찬 후기 이유식입니다.',
 '진밥 80g, 새우살 25g, 냉동 완두콩 20g, 당근 10g, 야채 육수 120ml',
 array[
 ...
 '새우와 완두콩 모두 알레르기를 유발할 수 있는 식품입니다. 각각 알레르기 여부를 확인한 후에 함께 제공합니다.'),

('recipeLate10', 'late', '닭고기 표고버섯 리조또식 진밥',
 '리조또처럼 크리미한 질감의 후기 이유식으로, 표고버섯의 감칠맛과 닭고기의 담백함이 어우러진 고급스러운 한 끼입니다.',
 '진밥 80g, 닭가슴살 25g, 표고버섯 (기둥 제거) 20g, 양파 10g, 닭 육수 150ml',
 array[
 ...
 '표고버섯 향이 처음에는 낯설 수 있습니다. 처음 제공할 때는 표고버섯 양을 줄이고 점차 늘려가는 방식으로 접근합니다.')
